...
class FileStatus(StrEnum):
    """Класс-перечисление для представления вариантов статуса медиафайлов.

    Представляет собой единое перечисление всех возможных
    статусов медиафайлов.
...
class PasswordRuleType(StrEnum):
    """Перечисление типов значений правил валидации паролей.

    Определяет семантику поля `value` в правиле.
    ...
    CHARSET
        Множество разрешённых символов (строка).
    """
